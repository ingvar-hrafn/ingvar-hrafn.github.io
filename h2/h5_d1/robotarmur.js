...
var UPPEST_ARM_HEIGHT = 0.5;
var UPPEST_ARM_WIDTH = 2.0;
  ...
  window.addEventListener("keydown", function (e) {
    switch (e.keyCode) {
      ...
      case 65: // a - snýr neðri armi
        ...
        break;
      case 75: // k - snýr efsta armi
        theta[3] = Math.min(-90, theta[3] - 5);
        break;
      case 76: // l - snýr efsta armi
        theta[3] = Math.min(90, theta[3] + 5);
        break;
...
function uppestArm() {
  var s = scalem(UPPEST_ARM_WIDTH, UPPEST_ARM_HEIGHT, UPPEST_ARM_WIDTH);
  var instanceMatrix = mult(translate(0.0, 0.5 * UPPEST_ARM_HEIGHT, 0.0), s);
  var t = mult(modelViewMatrix, instanceMatrix);
  gl.uniformMatrix4fv(modelViewMatrixLoc, false, flatten(t));
  gl.drawArrays(gl.TRIANGLES, 0, NumVertices);
}
...
var render = function () {
  ...
  modelViewMatrix = mult(modelViewMatrix, rotateY(theta[UppestArm]));
  uppestArm();
